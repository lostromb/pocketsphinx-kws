...
//    public struct BasicDebugPointer<T> : Pointer<T>
//    {
//        private T[] _array;
//        private int _offset;
...
//        /// <param name="t"></param>
//        /// <returns></returns>
//        public static T operator +(BasicDebugPointer<T> t)
//        {
//            return t[0];
//        }

//        public static BasicDebugPointer<T> operator ++(BasicDebugPointer<T> t)
//        {
//            return t.Point(1);
//        }
...
//        /// <returns></returns>
//        public static Pointer<T> operator +(BasicDebugPointer<T> arg, int offset)
//        {
//            return new Pointer<T>(arg._array, arg._offset + offset);
//        }

//        public static Pointer<T> operator +(BasicDebugPointer<T> arg, uint offset)
//        {
